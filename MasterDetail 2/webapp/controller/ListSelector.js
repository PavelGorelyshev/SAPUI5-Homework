sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("jetCourses.MasterDetailApp.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias jetCourses.MasterDetailApp.controller.ListSelector
			 */
			 ...
			 * @return {jetCourses.MasterDetailApp.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
