...
sap.ui.define([
		...
		"zjblesson02/Worklist/model/formatter"
	], function (
		BaseController,
		JSONModel,
		History,
		...
		return BaseController.extend("zjblesson02.Worklist.controller.Object", {
			...
			_onBindingChange : function () {
				...
				this.addHistoryEntry({
					...
					intent: "#Cars-display&/zjblessons_base_Materials/" + sObjectId
				});
