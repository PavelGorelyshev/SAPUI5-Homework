sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblesson02/WorklistShoes/app", ".html");
		...
		return Opa5.extend("zjblesson02.WorklistShoes.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblesson02/WorklistShoes/localService/mockserver"], function (mockserver) {
